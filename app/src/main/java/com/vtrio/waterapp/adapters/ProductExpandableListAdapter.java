...
public class ProductExpandableListAdapter extends BaseExpandableListAdapter {
    ...
    public View getGroupView(final int i, boolean b, View view, ViewGroup viewGroup) {
        ...
        Log.d("WaterApp", "@position : " + i + "productItem quantity : " + productItems.getProductItemQty());
    ...
    private void changeQuantity(final ProductItemBinding productItemsBinding, int observableIntQty, String operand) {


        switch (operand) {
            case Constants.ADDITION:
                if (observableIntQty >= 0) {
                    productItemsBinding.getProductItems().setProductItemQty(observableIntQty + 1);
                }
                break;
